...
char* openssl_hash(char* file, void* context, int length, int (*init)(void*), int (*update)(void*, void*, size_t), int (*final)(unsigned char*, void*)) {
	init(context);
...
char* hash_md5(char* file) {
	MD5_CTX context;
	return openssl_hash(file, &context, MD5_DIGEST_LENGTH, (int (*)(void*)) MD5_Init, (int (*)(void*, void*, size_t)) MD5_Update,
	                    (int (*)(unsigned char*, void*)) MD5_Final);
}

char* hash_sha1(char* file) {
	SHA_CTX context;
	return openssl_hash(file, &context, SHA_DIGEST_LENGTH, (int (*)(void*)) SHA1_Init, (int (*)(void*, void*, size_t)) SHA1_Update,
	                    (int (*)(unsigned char*, void*)) SHA1_Final);
}

char* hash_sha256(char* file) {
	SHA256_CTX context;
	return openssl_hash(file, &context, SHA256_DIGEST_LENGTH, (int (*)(void*)) SHA256_Init, (int (*)(void*, void*, size_t)) SHA256_Update,
	                    (int (*)(unsigned char*, void*)) SHA256_Final);
}

char* hash_sha512(char* file) {
	SHA512_CTX context;
	return openssl_hash(file, &context, SHA512_DIGEST_LENGTH, (int (*)(void*)) SHA512_Init, (int (*)(void*, void*, size_t)) SHA512_Update,
	                    (int (*)(unsigned char*, void*)) SHA512_Final);
}

char* hash_rmd160(char* file) {
	RIPEMD160_CTX context;
	return openssl_hash(file, &context, RIPEMD160_DIGEST_LENGTH, (int (*)(void*)) RIPEMD160_Init, (int (*)(void*, void*, size_t)) RIPEMD160_Update,
	                    (int (*)(unsigned char*, void*)) RIPEMD160_Final);
}

char* hash_whirlpool(char* file) {
	WHIRLPOOL_CTX context;
	return openssl_hash(file, &context, WHIRLPOOL_DIGEST_LENGTH, (int (*)(void*)) WHIRLPOOL_Init, (int (*)(void*, void*, size_t)) WHIRLPOOL_Update,
